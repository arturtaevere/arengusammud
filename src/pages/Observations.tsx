...
import { Plus, Filter, List, Grid, BookOpen, MessageSquare, ClipboardCheck } from 'lucide-react';
        ...
        <Tabs defaultValue="observations" className="mb-8">
          ...
          <TabsContent value="feedback">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="text-sm text-gray-500">
                Kokku: {feedbacks.length} tagasisidestust
              </div>
            </div>
            ...
            <div className="grid gap-4">
              {feedbacks.map((feedback) => (
                <Card key={feedback.id} className="transition-all hover:shadow-md">
                  ...
                  <CardContent>
                    <p className="text-sm text-gray-600 line-clamp-2">{feedback.preview}</p>
                  </CardContent>
                  <CardFooter>
